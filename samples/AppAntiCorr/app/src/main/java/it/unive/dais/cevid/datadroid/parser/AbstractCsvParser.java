...
import it.unive.dais.cevid.datadroid.util.Prelude;
 ...
 */
public abstract class AbstractCsvParser<Data> extends AbstractDataParser<Data, Integer, BufferedReader> {

    private static final String TAG = "AbstractCsvParser";

    private final boolean hasActualHeader;
    @NonNull private final String sep;
     ...
     * @param reader reader di input.
     * @return lista di Data.
     * @throws IOException lanciata se il reader fallisce.
     */
    @Override
    @NonNull
    protected List<Data> parse(BufferedReader reader) throws IOException {
